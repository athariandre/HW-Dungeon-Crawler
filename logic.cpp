...
char** resizeMap(char** map, int& maxRow, int& maxCol) {
    ...
    if(map == nullptr || ((INT32_MAX / (2*maxRow)) < (2*maxCol)) || ((INT32_MAX / (2*maxCol)) < (2*maxRow)) || (INT32_MAX / maxRow < maxCol) || (INT32_MAX / maxCol < maxRow) || (maxRow*2 > 999999) || (maxCol*2 > 999999)){
        return nullptr;
    } 
